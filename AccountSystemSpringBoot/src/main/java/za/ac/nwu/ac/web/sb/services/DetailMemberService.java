...
public class DetailMemberService {
    @Autowired
    Member_Repo repo;
    public Member listMember(Long id) throws ResourceNotFoundException {
        return repo.findById(id).orElseThrow(() -> new ResourceNotFoundException("Member account not found for this id :: "+id));
    }
}
